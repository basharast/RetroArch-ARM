      ...
      case SETTINGS_LIST_CORE:
         {
            ...
            bool_entries[listing].target         = &settings->bools.core_resolve_win32_enable;
            bool_entries[listing].name_enum_idx  = MENU_ENUM_LABEL_CORE_RESOLVE_WIN32_ENABLE;
            bool_entries[listing].SHORT_enum_idx = MENU_ENUM_LABEL_VALUE_CORE_RESOLVE_WIN32_ENABLE;
            bool_entries[listing].default_value  = DEFAULT_CORE_RESOLVE_WIN32_ENABLE;
            bool_entries[listing].flags          = SD_FLAG_ADVANCED;
            listing++;
